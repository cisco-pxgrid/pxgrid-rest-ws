 ...
 */
public class TrustsecSxpBindingSubscribe {
	...
	public static void main(String [] args) throws Exception {
		...
		Service[] services = control.lookupService("com.cisco.ise.sxp");
		...
		String topic = sessionService.getProperties().get("bindingTopic");
