 ...
 */
public class TrustsecSecurityGroupSubscribe {
	...
	public static void main(String [] args) throws Exception {
		...
		Service[] services = control.lookupService("com.cisco.ise.config.trustsec");
		...
		String topic = sessionService.getProperties().get("securityGroupTopic");
